...
message(STATUS "gripper_pkg: 1 messages, 0 services")

set(MSG_I_FLAGS "-Igripper_pkg:/home/hasan/ROS_MATE_2023_WS/src/gripper_pkg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/hasan/ROS_MATE_2023_WS/src/gripper_pkg/msg/Gripper.msg" NAME_WE)
add_custom_target(_gripper_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gripper_pkg" "/home/hasan/ROS_MATE_2023_WS/src/gripper_pkg/msg/Gripper.msg" ""
)
...
_generate_msg_cpp(gripper_pkg
  "/home/hasan/ROS_MATE_2023_WS/src/gripper_pkg/msg/Gripper.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gripper_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gripper_pkg\")")
  # install generated code
  install(
