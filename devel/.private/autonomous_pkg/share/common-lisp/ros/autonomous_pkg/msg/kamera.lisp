...
(cl:defmethod cl:initialize-instance :after ((m <kamera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'kamera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonomous_pkg-msg:<kamera> is deprecated: use autonomous_pkg-msg:kamera instead.")))
