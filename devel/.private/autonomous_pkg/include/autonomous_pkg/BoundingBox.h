// Generated by gencpp from file autonomous_pkg/BoundingBox.msg
// DO NOT EDIT!


#ifndef AUTONOMOUS_PKG_MESSAGE_BOUNDINGBOX_H
#define AUTONOMOUS_PKG_MESSAGE_BOUNDINGBOX_H
...
struct BoundingBox_
{
  ...
  typedef boost::shared_ptr< ::autonomous_pkg::BoundingBox_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autonomous_pkg::BoundingBox_<ContainerAllocator> const> ConstPtr;

}; // struct BoundingBox_

typedef ::autonomous_pkg::BoundingBox_<std::allocator<void> > BoundingBox;

typedef boost::shared_ptr< ::autonomous_pkg::BoundingBox > BoundingBoxPtr;
typedef boost::shared_ptr< ::autonomous_pkg::BoundingBox const> BoundingBoxConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autonomous_pkg::BoundingBox_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autonomous_pkg::BoundingBox_<ContainerAllocator1> & lhs, const ::autonomous_pkg::BoundingBox_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autonomous_pkg::BoundingBox_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autonomous_pkg::BoundingBox_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autonomous_pkg::BoundingBox_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autonomous_pkg::BoundingBox_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16489477eaaf0dbcULL;
  static const uint64_t static_value2 = 0xa582174d9a0d8936ULL;
};

template<class ContainerAllocator>
struct DataType< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autonomous_pkg::BoundingBox_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autonomous_pkg::BoundingBox_<ContainerAllocator>& v)
  {
...
#endif // AUTONOMOUS_PKG_MESSAGE_BOUNDINGBOX_H
