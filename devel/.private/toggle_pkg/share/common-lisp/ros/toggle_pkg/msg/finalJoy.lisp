...
(cl:defclass <finalJoy> (roslisp-msg-protocol:ros-message)
  ((leftX
    :reader leftX
    :initarg :leftX
    :type cl:string
...
(cl:defclass finalJoy (<finalJoy>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <finalJoy>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'finalJoy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name toggle_pkg-msg:<finalJoy> is deprecated: use toggle_pkg-msg:finalJoy instead.")))

(cl:ensure-generic-function 'leftX-val :lambda-list '(m))
(cl:defmethod leftX-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:leftX-val is deprecated.  Use toggle_pkg-msg:leftX instead.")
  (leftX m))

(cl:ensure-generic-function 'leftY-val :lambda-list '(m))
(cl:defmethod leftY-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:leftY-val is deprecated.  Use toggle_pkg-msg:leftY instead.")
  (leftY m))

(cl:ensure-generic-function 'rightX-val :lambda-list '(m))
(cl:defmethod rightX-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:rightX-val is deprecated.  Use toggle_pkg-msg:rightX instead.")
  (rightX m))

(cl:ensure-generic-function 'rightY-val :lambda-list '(m))
(cl:defmethod rightY-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:rightY-val is deprecated.  Use toggle_pkg-msg:rightY instead.")
  (rightY m))

(cl:ensure-generic-function 'alter_right_x-val :lambda-list '(m))
(cl:defmethod alter_right_x-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:alter_right_x-val is deprecated.  Use toggle_pkg-msg:alter_right_x instead.")
  (alter_right_x m))

(cl:ensure-generic-function 'alter_right_y-val :lambda-list '(m))
(cl:defmethod alter_right_y-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:alter_right_y-val is deprecated.  Use toggle_pkg-msg:alter_right_y instead.")
  (alter_right_y m))

(cl:ensure-generic-function 'R1-val :lambda-list '(m))
(cl:defmethod R1-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:R1-val is deprecated.  Use toggle_pkg-msg:R1 instead.")
  (R1 m))

(cl:ensure-generic-function 'R2-val :lambda-list '(m))
(cl:defmethod R2-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:R2-val is deprecated.  Use toggle_pkg-msg:R2 instead.")
  (R2 m))

(cl:ensure-generic-function 'L1-val :lambda-list '(m))
(cl:defmethod L1-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:L1-val is deprecated.  Use toggle_pkg-msg:L1 instead.")
  (L1 m))

(cl:ensure-generic-function 'L2-val :lambda-list '(m))
(cl:defmethod L2-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:L2-val is deprecated.  Use toggle_pkg-msg:L2 instead.")
  (L2 m))

(cl:ensure-generic-function 'btn_triangle-val :lambda-list '(m))
(cl:defmethod btn_triangle-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:btn_triangle-val is deprecated.  Use toggle_pkg-msg:btn_triangle instead.")
  (btn_triangle m))

(cl:ensure-generic-function 'btn_square-val :lambda-list '(m))
(cl:defmethod btn_square-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:btn_square-val is deprecated.  Use toggle_pkg-msg:btn_square instead.")
  (btn_square m))

(cl:ensure-generic-function 'btn_circle-val :lambda-list '(m))
(cl:defmethod btn_circle-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:btn_circle-val is deprecated.  Use toggle_pkg-msg:btn_circle instead.")
  (btn_circle m))

(cl:ensure-generic-function 'btn_cross-val :lambda-list '(m))
(cl:defmethod btn_cross-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:btn_cross-val is deprecated.  Use toggle_pkg-msg:btn_cross instead.")
  (btn_cross m))

(cl:ensure-generic-function 'AutonomMode-val :lambda-list '(m))
(cl:defmethod AutonomMode-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:AutonomMode-val is deprecated.  Use toggle_pkg-msg:AutonomMode instead.")
  (AutonomMode m))

(cl:ensure-generic-function 'PID_DepthMode-val :lambda-list '(m))
(cl:defmethod PID_DepthMode-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:PID_DepthMode-val is deprecated.  Use toggle_pkg-msg:PID_DepthMode instead.")
  (PID_DepthMode m))

(cl:ensure-generic-function 'PID_StabilizeMode-val :lambda-list '(m))
(cl:defmethod PID_StabilizeMode-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:PID_StabilizeMode-val is deprecated.  Use toggle_pkg-msg:PID_StabilizeMode instead.")
  (PID_StabilizeMode m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:throttle-val is deprecated.  Use toggle_pkg-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'Mission1_Mode-val :lambda-list '(m))
(cl:defmethod Mission1_Mode-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:Mission1_Mode-val is deprecated.  Use toggle_pkg-msg:Mission1_Mode instead.")
  (Mission1_Mode m))

(cl:ensure-generic-function 'Mission2_Mode-val :lambda-list '(m))
(cl:defmethod Mission2_Mode-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:Mission2_Mode-val is deprecated.  Use toggle_pkg-msg:Mission2_Mode instead.")
  (Mission2_Mode m))

(cl:ensure-generic-function 'Mission3_Status-val :lambda-list '(m))
(cl:defmethod Mission3_Status-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:Mission3_Status-val is deprecated.  Use toggle_pkg-msg:Mission3_Status instead.")
  (Mission3_Status m))

(cl:ensure-generic-function 'Mission4_Status-val :lambda-list '(m))
(cl:defmethod Mission4_Status-val ((m <finalJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader toggle_pkg-msg:Mission4_Status-val is deprecated.  Use toggle_pkg-msg:Mission4_Status instead.")
  (Mission4_Status m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <finalJoy>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <finalJoy>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<finalJoy>)))
  "Returns string type for a message object of type '<finalJoy>"
  "toggle_pkg/finalJoy")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'finalJoy)))
  "Returns string type for a message object of type 'finalJoy"
  "toggle_pkg/finalJoy")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<finalJoy>)))
  "Returns md5sum for a message object of type '<finalJoy>"
  "3d20946d4d46cc16c1a33df6866b61f3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'finalJoy)))
  "Returns md5sum for a message object of type 'finalJoy"
  "3d20946d4d46cc16c1a33df6866b61f3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<finalJoy>)))
  "Returns full string definition for message of type '<finalJoy>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'finalJoy)))
  "Returns full string definition for message of type 'finalJoy"
  (cl:format cl:nil "string leftX~%string leftY~%string rightX~%string rightY~%string alter_right_x~%string alter_right_y~%string R1~%string R2~%string L1~%string L2~%string btn_triangle~%string btn_square~%string btn_circle~%string btn_cross~%string AutonomMode~%string PID_DepthMode~%string PID_StabilizeMode~%string throttle~%~%# Circle~%string Mission1_Mode ~%# Cross~%string Mission2_Mode~%# Start~%string Mission3_Status~%# Select~%string Mission4_Status ~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <finalJoy>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <finalJoy>))
