...
// (in-package joy_converter_pkg.msg)
...
class joy_converter {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new joy_converter(null);
  ...
  static datatype() {
    ...
    return 'joy_converter_pkg/joy_converter';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new joy_converter(null);
