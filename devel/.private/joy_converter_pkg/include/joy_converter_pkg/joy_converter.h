// Generated by gencpp from file joy_converter_pkg/joy_converter.msg
// DO NOT EDIT!


#ifndef JOY_CONVERTER_PKG_MESSAGE_JOY_CONVERTER_H
#define JOY_CONVERTER_PKG_MESSAGE_JOY_CONVERTER_H
...
namespace joy_converter_pkg
{
template <class ContainerAllocator>
struct joy_converter_
{
  typedef joy_converter_<ContainerAllocator> Type;
  ...
  joy_converter_(const ContainerAllocator& _alloc)
    : leftX(_alloc)
    , leftY(_alloc)
    , rightX(_alloc)
    , rightY(_alloc)
  ...
  typedef boost::shared_ptr< ::joy_converter_pkg::joy_converter_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::joy_converter_pkg::joy_converter_<ContainerAllocator> const> ConstPtr;

}; // struct joy_converter_

typedef ::joy_converter_pkg::joy_converter_<std::allocator<void> > joy_converter;

typedef boost::shared_ptr< ::joy_converter_pkg::joy_converter > joy_converterPtr;
typedef boost::shared_ptr< ::joy_converter_pkg::joy_converter const> joy_converterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::joy_converter_pkg::joy_converter_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::joy_converter_pkg::joy_converter_<ContainerAllocator1> & lhs, const ::joy_converter_pkg::joy_converter_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::joy_converter_pkg::joy_converter_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::joy_converter_pkg::joy_converter_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::joy_converter_pkg::joy_converter_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
{
  ...
  static const char* value(const ::joy_converter_pkg::joy_converter_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3d20946d4d46cc16ULL;
  static const uint64_t static_value2 = 0xc1a33df6866b61f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string leftX\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::joy_converter_pkg::joy_converter_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::joy_converter_pkg::joy_converter_<ContainerAllocator>& v)
  {
    s << indent << "leftX: ";
...
#endif // JOY_CONVERTER_PKG_MESSAGE_JOY_CONVERTER_H
